...
class GaussianDiffusion:
    ...
    def calculate_loss_previous_task(self, current_model, prev_model, schedule_sampler, task_id, n_examples_per_task,
                                     shape, denoised_fn=None, clip_denoised=False, cond_fn=None, batch_size=-1):

        imgs_curr_mean, imgs_curr_variance, imgs_prev_mean, imgs_prev_variance = self.partial_sample_loop(current_model,
                                                                                                          prev_model,
                                                                                                          schedule_sampler,
                                                                                                          task_id,
                                                                                                          n_examples_per_task,
